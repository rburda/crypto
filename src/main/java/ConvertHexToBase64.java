...
public class ConvertHexToBase64 {
	...
	public static void main(String args[]) {
		...
		System.out.println("*** initial hex ***");
		...
		Base64String base64 = binary.toBase64();
		System.out.println("*** Base 64 ***");
		System.out.println(base64.toString());

		System.out.println("*** re binaried ***");
		BinaryString reBinaried = base64.toBinary();
		System.out.println(reBinaried.toBitString());

		System.out.println("*** re hex ***");
		System.out.println(reBinaried.toHex().toString());
	}
}